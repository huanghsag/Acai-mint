...
export declare const send: ({ gatheredUtxos, toAddress, amount, runeId, inscriptionAddress, feeRate, account, provider, signer, noBroadcast, }: {
    gatheredUtxos: GatheredUtxos;
    toAddress: string;
    amount: number;
    runeId: string;
...
export declare const mint: ({ gatheredUtxos, account, runeId, provider, feeRate, signer, noBroadcast, }: {
    gatheredUtxos: GatheredUtxos;
    account: Account;
    runeId: string;
    provider: Provider;
